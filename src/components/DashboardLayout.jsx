        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-black relative mt-[-40px]">
          <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-8">
            <div className="flex flex-col gap-2 sm:gap-3">
              ...
              <div className="sticky mb-5 top-[64px] z-20 bg-black/98 backdrop-blur-md py-3 border border-green-500/20 rounded-lg shadow-lg">
                <div className="px-3 sm:px-4">
                  ...
                  >
                      ...
                      {breadcrumbItems.map((item, index) => (
                        <React.Fragment key={item.path}>
                          <button
                            ...
                            className={`
                              group relative px-2 py-1 rounded-md font-mono text-xs transition-all duration-200
                              ${
                                item.isActive
                          ...
                          >
                            ...
                            {/* Active indicator */}
                            {item.isActive && (
                              <span className="absolute -top-1 -right-1 w-1.5 h-1.5 bg-green-400 rounded-full animate-ping"></span>
                            )}
                          </button>
                          ...
                          {index < breadcrumbItems.length - 1 && (
                            <svg
                              className="w-3 h-3 text-green-500/40"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                    ...
                    <div className="mt-2 text-green-400/60 text-xs font-mono">
                      <span>→ Current location: {location.pathname}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black rounded-lg shadow-lg border border-green-500/20 p-3 sm:p-6 relative overflow-hidden">
                ...
                <div
                  className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-green-500/10 to-transparent rounded-full blur-3xl animate-pulse"
